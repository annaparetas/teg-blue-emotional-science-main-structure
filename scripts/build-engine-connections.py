...
EXTRA_RELATIONSHIPS: dict[str, tuple[tuple[str, ...], str]] = {
    "evidence/reviews/regulation-route-consolidation.md": (("03-model-2-gradient/return.html", "02-model-1-ess-cls-me/me-access.html", "04-model-3-esc/cycle.html", "01-signal-map/grounding/recruitment-persistence-and-recovery.html", "05-frameworks/index.html", "06-inner-compass-four-modes/index.html", "STATUS.md"), "Completed bounded PEND-052 research consolidation of fourteen routes and eleven Return wording decisions; allocation functions and evidence limits are retained, with owner acceptance and public implementation pending."),
    'evidence/reviews/belonging-at-risk-and-return.md': (('01-signal-map/grounding/evidence-connections.html', '01-signal-map/index.html', '01-signal-map/grounding/neurochemistry.html', '03-model-2-gradient/return.html', '04-model-3-esc/index.html'), 'Nine conditional Belonging-at-Risk entry scopes, 31 chemical-link decisions and Return questions appear in the approved working explorer; the full review and source extraction remain Engine-owned, with public taxonomy unchanged.'),
    'evidence/reviews/belonging-at-risk-link-audit.csv': (('01-signal-map/grounding/evidence-connections.html', '01-signal-map/grounding/neurochemistry.html',), 'One review decision for each of 31 proposed chemical links; includes null, indirect and unresolved findings, not empirical adjacency weights.'),
    'evidence/reviews/belonging-at-risk-link-sources.json': (('01-signal-map/grounding/evidence-connections.html', '01-signal-map/grounding/neurochemistry.html',), 'Source lookup for BAR-S01 to BAR-S22; canonical extraction remains in the Engine shared source index.'),
    'evidence/reviews/belonging-at-risk-diagram-review.json': (('01-signal-map/grounding/evidence-connections.html', '01-signal-map/index.html', '01-signal-map/grounding/neurochemistry.html', '03-model-2-gradient/return.html'), 'Source handoff for the approved working evidence explorer: nine conditional memberships, 31 link decisions and Return questions; scores describe recorded connectivity, with public taxonomy unchanged.'),
    'evidence/reviews/return-connection-solitude-and-restoration.md': (('03-model-2-gradient/return.html', '03-model-2-gradient/index.html', '04-model-3-esc/index.html', '05-frameworks/F08/review.md'), 'Engine Return-assumption audit covering connection, solitude, restoration and A to X; research connection only, with public integration deferred.'),
    'evidence/reviews/emotion-regulation-strategy-context-and-cost.md': (('02-model-1-ess-cls-me/me-access.html', '03-model-2-gradient/index.html', '04-model-3-esc/index.html', '05-frameworks/F03/review.md'), 'Engine emotion-regulation comparison of targets, timing, costs, context and choice; research connection only, with public integration deferred.'),
    'evidence/reviews/physiological-regulation-and-whole-system-inference.md': (('03-model-2-gradient/index.html', '03-model-2-gradient/premise.html', '02-model-1-ess-cls-me/me-access.html', '04-model-3-esc/index.html'), 'Engine physiological regulation and organisation-inference comparison; research connection only, with public integration deferred.'),
    'evidence/reviews/observation-monitoring-and-later-behaviour.md': (('04-model-3-esc/index.html', '05-frameworks/F04/review.md', '05-frameworks/F05/review.md', '05-frameworks/F07/review.md', '05-frameworks/F12/review.md'), 'Engine observation and later-behaviour evidence comparison; research connection only, with public integration deferred.'),
    ...
    'evidence/reviews/interpersonal-support-and-stress-buffering.md': (('03-model-2-gradient/return.html', '04-model-3-esc/index.html', '05-frameworks/F08/review.md'), 'Engine acute-support evidence comparison and recovery/Return boundaries; research connection only, with public integration deferred.'),
    ...
    'evidence/reviews/practical-help-workload-and-provider-cost.md': (('02-model-1-ess-cls-me/index.html', '03-model-2-gradient/return.html', '04-model-3-esc/index.html', '05-frameworks/F03/review.md'), 'Engine practical-help evidence comparison separating task change, recipient appraisal, choice and provider cost; research connection only, with public integration deferred.'),
    ...
    'evidence/reviews/rules-enforcement-and-later-behaviour.md': (('05-frameworks/F04/review.md', '05-frameworks/F05/review.md', '05-frameworks/F07/review.md', '05-frameworks/F12/review.md'), 'Engine institutional enforcement and withdrawal evidence comparison; research connection only, with public integration deferred.'),
    'evidence/reviews/apology-restitution-conduct-and-trust.md': (('03-model-2-gradient/return.html', '04-model-3-esc/index.html', '05-frameworks/F08/review.md'), 'Engine Repair evidence comparison separating apology, restitution, subsequent conduct, trust and affected-person recovery; research connection only, with public integration deferred.'),
    'evidence/reviews/task-completion-and-continuing-responses.md': (('03-model-2-gradient/return.html', '04-model-3-esc/index.html', '05-frameworks/F08/review.md'), 'Engine task-completion evidence comparison separating task endpoints, continuing cognition and recovery; research connection only, with public integration deferred.'),
    ...
    "development/model-notes/inner-compass-tool-requirements-and-model-4-proposal.md": (("06-inner-compass-four-modes/index.html", "06-inner-compass-four-modes/notes/decisions.md", "STATUS.md"), "Accepted Inner Compass participation direction and proposed Model 4 development, tracked by PEND-056 after Regulation consolidation; four-mode definitions, ownership, designation and tool reconnection remain pending."),
