...
## What this inventory makes visible

The present files do not describe one process at one timescale. They examine related questions that can easily be mistaken for one another:

- how regulatory capacities became available across evolutionary history;
- how experience and relationship may shape access, meaning and action during development;
- how a person is organised in relation to present conditions;
- how recruitment, interpretation, action or recovery may become persistent or difficult to revise;
- what a person does, what the behaviour costs, and whether power restricts another person's options;
- how a scientific source can support one part of this account without validating the whole assembly.

The architecture is coherent when each file answers its own question and hands the next question forward. It becomes less coherent when evolutionary history explains childhood learning, physiological organisation explains harmful behaviour, or a research family is treated as evidence for a complete Gradient Position.

## The explanatory architecture
...
Conditions, bodily and situational information, meaning and participation (Inner Compass)
        ↓
Present-responsive whole-organism organisation (Fluid)
        ↓
Outcome, updating, recovery and Return
        ↓
Possible persistence routes (Chronic)

At every point where behaviour affects another person:
        → action · power · impact · responsibility · repair (Harm–Power–Repair)
```

This sequence is a TEG-Blue organising structure. It is not one established biological pathway. Its arrows contain separate claims that may require evidence from different levels and timescales.
...
| --- | --- | --- |
| [Science Grounding Protocol](../protocol.html) | Governs evidence handling | Decide claim type, source role, confidence and boundary |
| [Scientific Lineage and Integrative Grounding](scientific-lineage-and-integrative-grounding.md) | Governs system-level scientific identity | Keep interacting levels, timescales and knowledge families distinct |
| [Current Construct Grounding Registry](../claims/current-construct-grounding-registry.md) | Governs construct IDs and ownership | Route a construct to the correct layer and evidence task |
| [Current Construct Claim Decomposition](../claims/current-construct-decomposition.md) | Governs claim units | Separate definition, phenomenon, mechanism, development, application and boundary |
| [Project Terminology Ledger](../../GLOSSARY.md) | Governs vocabulary state | Show which terms are accepted, implemented, provisional, retired or open |

### Research-routing documents
...
The three pilots test the reusable source-record method across the bridges most likely to affect several framework layers:

1. [Allostasis, Resource Allocation and Return](../pilots/PILOT-01-allostasis-resource-allocation-and-return.md)
2. [Interoception, Bodily Representation and Conscious Access](../pilots/PILOT-02-interoception-bodily-representation-and-access.md)
3. [Learning, Controllability, Generalisation and Updating](../pilots/PILOT-03-learning-controllability-generalisation-and-updating.md)

Their terminology decisions have begun to move into active pages. Their source records remain first-pass evidence, not final reviews of each field.

### Active explanatory pages
...
Skeleton Markdown files, working panels, original diagrams and archived pages preserve development history. They can recover an observation or show why a term arose. They do not override an active page or a later terminology decision.
...
| Did a behaviour restrict another person's agency or cause harm? | Harm–Power–Repair | behaviour, coercive control, ethics, law, social and relational research |
| What does a term mean inside TEG-Blue? | Construct registry and terminology ledger | active pages and claim decomposition |
| What can a source actually establish? | Source record under the grounding protocol | relevant research map or crosswalk |

## Collisions now visible
...
The Inner Compass describes information processing and participation. The Fluid Gradient describes a proposed whole-organism organisation in relation to current conditions. A person may have bodily information without clear conscious access, and a Fluid response may still be painful, forceful or immobilised.

### Chronic organisation and trauma

Trauma-related research can ground particular mechanisms or outcomes. Chronic organisation is not a trauma diagnosis, and present organisation cannot establish a particular exposure history.

### Defensive organisation and harmful behaviour

Protective mobilisation may contribute pressure towards action. It does not specify whether someone withdraws, asks for help, sets a boundary, attacks, coerces or repairs. The behaviour and power planes remain necessary.

### Return and repair

Return concerns changes in protective demand, recovery, updating and renewed capacity. Repair concerns what happens after behaviour affects another person. Physiological recovery does not complete relational repair, and apology does not by itself establish biological recovery or changed learning.

## Gaps to carry into the next review
...
When a new idea enters the project, ask in this order:

1. Which layer owns the question?
2. Which exact claim type is involved?
3. Is the proposed term a research construct, a bounded translation, a TEG-Blue integration or an accessible umbrella?
4. What evidence level is required?
5. What must remain unclaimed?
6. Which active pages would change if the decision is accepted?

This order lets the framework develop without asking one source, one term or one diagram to explain more than it can.
