...
Gradient page's sliders become a read-only echo; its interoceptive,
affective-sharing, mentalizing and conscious-availability rows show their
band and fade at lower bands. The capacities page's switches share the same
setting. What responds, what must not, and the next stages are in
[Model 2's controller plan](../../03-model-2-gradient/notes/capacity-controller-plan.md).
Built on my recommendations (graded, emphasis only, no depth marker) pending
Anna's confirmation.
...
- **Anna's decision, 2 September 2026:** keep the teaching lines. "Fast ·
  ...
  beside its boundary: a tendency, not a division; ESS is not complete
...
- The coordinated conscious access page is carried as [access.html](../access.html)
  ...
  working, and is designated the future controller for the Gradient's
  capacity rows. The sensory processing
  page is carried as [processing.html](../processing.html), grounding.
- The component decomposition, the configuration-to-clinical-pattern bridge
  and the six-cluster synthesis are carried into `grounding/`. The
...
capacity; whether cell text changes per band or only emphasis.

## 2026-08-27 · Model 1 owner review opened

M1-S1 opened with the Love reference case as the concrete test. A read-only
handoff returned an authority map, an acceptance and correction matrix,
mixed-owner routing and a decision agenda. Awaiting Anna's decisions. The
handoff exists only in the review task and should be exported here.

## 2026-08-26 · Names settled; access relationship renamed

Accessible name: The Two Biological Information Systems and ME. Subtitle:
emotional–somatic and reflective–symbolic information processing, conscious
access and human participation. Short label: ESS · CLS · ME. Inner Compass
reserved for the public product; the access relationship becomes
coordinated conscious access, with its canonical page. ME, never "the ME".
Signal Map records use "conscious availability to ME", separate from
possible ME participation.

## 2026-08-23 · Companion draft written

Foundation 21 drafted with the four canonical terms, the presence-to-use
distinction, timing evidence, and the reconciliation request about the
fast–slow shorthand.

## 2026-08-21 · Model sketch and legacy deep dive

The sketch gathered the architecture into one provisional model: governing
premise, seven ESS and eight CLS components, shared territories, the
presence-to-use ladder, the regulation warning, the coherence audit and the
diagram requirements. The legacy deep dive extracted every earlier ESS, CLS
and ME idea and marked each preserve, revise, retire or unresolved.

## 2026-08-19 · Names retained; nine boundaries; component decomposition

ESS and CLS retained as names with scientific-facing descriptions. Nine
non-negotiable boundaries. Component claim decomposition begun. The
configuration-to-clinical-pattern bridge and the six-cluster synthesis
