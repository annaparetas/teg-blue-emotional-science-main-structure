...
> **Shared Rules and Collective Organisation**

Suggested explanatory line:

> How groups create, transmit, apply and revise explicit and implicit expectations—and how those expectations shape participation, belonging, behaviour and access.

“Rules Regulate” preserves an important observation: rules do more than describe preferred behaviour. They can alter uncertainty, coordination, belonging, consequences and the options people realistically have.
...
- how people learn what is expected and what follows non-compliance;
- what coordination, protection, identity or continuity a rule supports;
- whose interpretation of the rule counts;
- how roles and power affect application;
- whether refusal, exception, disagreement and appeal remain possible;
- how a rule changes when conditions or consequences become visible;
- how practices continue across relationships, generations and institutions.

It does not own one person's developmental origin, the internal state behind compliance, the biological organisation of a group, a universal theory of culture, the moral value of every rule, the full structure of hierarchy or the assessment of harm and coercion.

## The core insight worth preserving

People often encounter rules before they can see that alternatives exist. Some rules are written. Others become visible only when someone breaks them.

A child may learn that sadness is private because adults repeatedly redirect it. A team may learn that disagreement is costly because objections are ignored or punished. A community may preserve a practice because it carries knowledge, identity and continuity. These are all forms of social learning, but they are not the same process and do not have the same meaning.

The strongest original insight is therefore:

> Repeated expectations can become part of the conditions people organise within, especially when belonging, authority, resources or consequences make those expectations difficult to question.

Several distinctions follow:

- a shared expectation is not automatically an explicit rule;
- repeated behaviour is not proof that everyone endorses the norm;
- compliance is not consent;
- tradition is not proof of legitimacy or harm;
- coordination is not the same as conformity;
- a rule can protect some people while placing costs on others;
- flexibility is not the absence of rules;
- contestability is not the same as constant negotiation;
- a group pattern is not a shared Gradient Position;
- an individual's explanation cannot establish why an institution persists.
...
| --- | --- | --- |
| **Explicit rule** | A stated expectation with a defined or implied scope, source and consequence | A written rule may be ignored, selectively applied or contradicted by practice |
| **Implicit norm** | An expectation communicated through approval, disapproval, repetition, modelling or anticipated social consequence | Similar behaviour does not prove shared belief or free agreement |
| **Role expectation** | Behaviour expected because of a person's place in a family, group, workplace or institution | A role can be negotiated, imposed, chosen, inherited or contested |
| **Practice or routine** | A repeated way of doing something that may organise participation without being stated as a rule | Repetition may reflect convenience, constraint or lack of alternatives rather than endorsement |
...
individual participation
        ↕
interaction and relationship patterns
        ↕
shared meanings, norms and roles
        ↕
...
| --- | --- |
| Rules can become difficult to see | Repeated expectations may come to feel ordinary or inevitable; visibility depends on role, power, alternatives and whose experience is heard |
| Rules can support identity and belonging | Shared expectations may coordinate membership and continuity while also defining who is permitted to participate and on what terms |
| Rules affect boundaries and resources | Formal and informal expectations can change access, authority, labour, credibility and the practical cost of refusal |
| Rules can continue across generations | Practices, stories, role expectations, material conditions and institutions may be transmitted through several distinct social routes |
| Pressure can affect rule use | Uncertainty, danger or conflict may change how rules are interpreted or enforced, but the direction is contextual rather than fixed |
| Emotion socialisation can affect later participation | Repeated responses to emotion may shape expression, anticipation and help-seeking without erasing the underlying feeling or proving a permanent developmental gap |
...
| Rules serve identifiable regulatory functions | Purpose cannot be inferred from persistence, and different participants may experience different functions | Separate stated purpose, immediate coordination, longer-term effect and distribution of cost |
| Rules tighten “predictably” as collective threat rises | Groups may centralise, cooperate, fragment, protect exceptions or intensify enforcement depending on leadership, history, institutions and power | Treat threat-related rule change as a claim requiring specified conditions, measures and timescale |
| Flexible → rigid → surveilled → enforced | This reads as a universal escalation pathway even though surveillance and enforcement can occur without those stages | Use separate dimensions: clarity, scope, discretion, monitoring, sanction, refusal and reviewability |
| Rules shape children mainly through adults | Children also encounter explicit rules, peers, schools, media, technologies, institutions and material conditions | Treat caregivers as one important route within a wider social ecology |
| Blocked expression creates a gap in the next generation's access to its own states | The statement moves too quickly from a social rule to an internal developmental outcome | Ask whether expression, language, attention, help-seeking or anticipated consequence changes, and what evidence supports each link |
| “Cost: flexibility” | Rules can reduce or increase flexibility depending on clarity, fit, scope, exception and revision | Assess coordination and cost separately rather than assigning one universal cost |
...
- **System justification, terror management, authoritarianism and social dominance** concern different constructs and levels. They should not be combined into a single rule-tightening mechanism.
- **Social exclusion research** may inform belonging, distress and participation. “Pain circuitry” is too broad to serve as the explanation for why a group rule persists.
...
expectation, practice or rule
        ↓
source + stated purpose + scope
        ↓
participation + authority + consequence
        ↓
coordination and differential effects
        ↓
contest, revision, persistence or enforcement
```
...
- **Collection role:** first explicitly collective Foundational Framework; connects individual participation to social, cultural and institutional conditions without treating a group as one organism.
...
| **Social and cultural anthropology** | Ethnographic accounts of meaning, practice, kinship, ritual, obligation, authority and variation across communities | A culture as uniform, timeless or governed by one psychological mechanism |
| **Linguistic anthropology, sociolinguistics and communication science** | How rules are named, implied, negotiated, performed and transmitted through language and interaction | Shared belief or free agreement inferred from repeated wording |
| **Political science and public administration** | Authority, governance, legitimacy, policy, state institutions, participation and implementation | Individual nervous-system organisation or private meaning |
| **Organisational science and industrial–organisational psychology** | Workplace roles, climate, leadership, incentives, routines, voice, silence and organisational change | Automatic transfer to families, cultures or political institutions |
| **Institutional and behavioural economics** | Incentives, coordination, resource allocation, externalities, bargaining and institutional constraints | Human value reduced to preference, price or rational choice |
| **Law-and-society and sociolegal research** | How formal rules operate in practice, how legitimacy and access vary, and how law interacts with social life | That legal validity establishes fairness, safety or voluntary participation |
| **Criminology and criminal-justice research** | Rule-breaking, enforcement, policing, punishment, prevention, institutional practice and unequal system effects | Criminality, intent or dangerousness inferred from identity, emotion or non-compliance alone |
| **Forensic and legal psychology** | Psychological knowledge applied to judicial, contractual and administrative questions | A general explanation of group rules or a licence to infer credibility and motive outside a psycholegal assessment |
| **History and historical sociology** | How rules, institutions, categories and material arrangements emerge, persist and change over time | A present function inferred directly from historical origin |
| **Archaeology and material-culture studies** | How built environments, objects and infrastructures organise recurring practice across time | The subjective meaning or endorsement of every participant |
| **Education research** | Rules, authority, participation, discipline, inclusion and learning within schools and educational systems | A universal developmental effect from one institutional practice |
| **Public health and social epidemiology** | Population effects of policy, inequality, exclusion, work, housing and institutional conditions | One person's internal mechanism or the legitimacy of a rule |
| **Human geography and demography** | Spatial organisation, mobility, population pattern, segregation, access and place-based conditions | Individual motive or lived meaning without corresponding qualitative evidence |
| **Social work and community psychology** | Community conditions, service systems, participation, prevention, implementation and collective repair | Independent validation of every mechanism used by a practice model |
| **Critical race, feminist, disability, decolonial and Indigenous scholarship** | Questions about whose knowledge counts, how categories and power operate, and what dominant measures may leave out | One internally uniform standpoint or decorative validation detached from the scholarship's context |
